    ...
    >
      ...
      >
        <div className="mx-auto flex w-full max-w-(--thread-max-width) flex-1 flex-col px-4 pt-4">
          ...
          <ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer sticky bottom-0 mt-auto flex flex-col gap-4 overflow-visible rounded-t-(--composer-radius) bg-white/10 backdrop-blur-md pb-4 md:pb-6">
  ...
  return (
    ...
    >
      <div
        ...
        className="wrap-break-word px-2 text-white leading-relaxed"
      >
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content wrap-break-word peer rounded-2xl bg-white/25 backdrop-blur-sm border border-white/30 px-4 py-2.5 text-white empty:hidden">
